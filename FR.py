...
def capture(read_frame_list, Global, worker_num):
    ...
    video_capture.set(4, 740)  # Width of the frames in the video stream.
    video_capture.set(5, 580)  # Height of the frames in the video stream.
...
def process(worker_id, read_frame_list, write_frame_list, Global, worker_num):
    ...
    while not Global.is_exit:
        ...
        for (top, right, bottom, left), face_encoding in zip(face_locations, face_encodings):
            ...
            cv2.rectangle(frame_process, (left, top), (right, bottom), (125, 40, 255), 2)

            # Draw a label with a name below the face
            cv2.rectangle(frame_process, (left, bottom - 35), (right, bottom), (125, 40, 255), cv2.FILLED)
...
if __name__ == '__main__':
    ...
    C_image = face_recognition.load_image_file("Subject_C.jpg")
